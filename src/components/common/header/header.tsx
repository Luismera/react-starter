				...
				<div className="main-header-container container-fluid">
					...
					<div className="header-content-right">
						...
						<Dropdown className="header-element cart-dropdown" autoClose="outside">
							<Dropdown.Toggle variant='' className="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside">
							...
							<Dropdown.Menu align="end" className="main-header-dropdown dropdown-menu  border-0 dropdown-menu-end" data-popper-placement="none">
												...
												<div className="d-flex align-items-start cart-">
													...
													<div className="flex-grow-1 ms-3">
														<div className="d-flex align-items-start justify-content-between mb-0">
															...
															<div>
																<Link aria-label="anchor" to="#" className="header-cart-remove float-end -close" onClick={() => handleRemove(idx.id)}><i className="ti ti-trash"></i></Link>
															</div>
														</div>
														<div className="min-w-fit-content align-items-start">
															<div className=" fw-normal fs-12 text-muted">Quantity:{idx.quantity}</div>
															<div className="d-flex  align-items-center">
																<span className="fw-semibold fs-16">{idx.newpr}</span>
																<p className="text-muted text-decoration-line-through ms-1 op-6 fs-12 mb-0">{idx.oldpr}</p>
															</div>
														</div>
													</div>
												</div>
								...
								<div className={`p-5 empty-item  ${cartItemCount === 0 ? "d-block" : "d-none"}`}>
									<div className="text-center">
										...
										<Link to="#" className="btn btn-primary btn-wave btn-sm m-1" data-abc="true">continue shopping <i className="bi bi-arrow-right ms-1"></i></Link>
									</div>
								</div>
							</Dropdown.Menu>
						</Dropdown>
